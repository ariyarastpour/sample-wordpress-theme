...
add_action('init', 'theme_redux_config', 2 );
function theme_redux_config() {
    ...
    $args = array(
        ...
        'menu_title'           => esc_html__('Theme Settings', THEME_NAME),
        'page_title'           => esc_html__('Theme Settings', THEME_NAME),
        ...
        'admin_bar_icon'       => 'isax isax-edit4',
    ...
    // Get all PHP files in the settings folder
    $options_files = glob( __DIR__ . '/settings/' . '*.php');
