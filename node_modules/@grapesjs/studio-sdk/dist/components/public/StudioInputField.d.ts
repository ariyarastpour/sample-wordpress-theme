...
export interface StudioLayoutInputFieldProps extends CommonStudioLayoutConfigProps<StudioInputFieldProps, StudioLayoutInputFieldConfig> {
}
export interface StudioInputFieldProps extends Omit<StudioLayoutInputFieldConfig, 'type' | 'label' | 'style' | 'onChange' | 'editorEvents'>, WithEditorEvents<StudioInputFieldState> {
    label?: React.ReactNode;
    style?: React.CSSProperties;
    onChange(props: {
        value: string;
    } & WithEditorState<StudioInputFieldState>): void;
}
