...
export interface StudioLayoutBaseConfig extends StudioLayoutBasePropsConfig {
    /**
...
export interface StudioLayoutFieldBaseConfig extends Pick<StudioLayoutBaseConfig, 'className' | 'style' | 'id'> {
    /**
