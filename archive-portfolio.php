...
<section class="max-w-6xl mx-auto px-4 py-10">
	<h1 class="text-3xl font-bold text-gray-800 mb-8 border-b-4 border-blue-500 pb-2 text-center">نمونه کارها</h1>
	<?php if ( have_posts() ) : ?>
	<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
		...
		<article class="bg-white rounded-2xl shadow hover:shadow-lg transition p-4">
			<a href="<?php the_permalink(); ?>" class="block group">
				...
				<div class="text-sm text-gray-500"><?php the_terms( get_the_ID(), 'portfolio_category', '', ', ' ); ?>
				</div>
			</a>
		</article>
		<?php endwhile; ?>
	...
	<?php else : ?>
	<p class="text-center text-gray-600">هیچ نمونه کاری یافت نشد.</p>
	<?php endif; ?>
</section>
<?php get_footer(); ?>